<div class="container">
	<div class="row my-2">
		<div class="col-lg my-2 py-2 header-title">
			<h3><i class="fas fa-sharp fa-solid fa-wine-glass"></i> Daftar Minuman</h3>
		</div>

		<?php if ($dataUser['jabatan'] == 'administrator') : ?>
			<div class="col-lg my-2 py-2 header-button">
				<a href="" class="btn btn-primary" data-toggle="modal" data-target="#tambahMenuModal"><i class="fas fa-sharp fa-solid fa-wine-glass fa-plus"></i> Tambah</a>
				<!-- Modal -->
							...
							<div class="modal-content text-left">
								...
								<div class="modal-body">
									<div class="form-group">
										<label for="nama_menu">Nama Minuman</label>
										<input type="text" id="nama_menu" class="form-control" placeholder="Masukkan Nama Minuman" name="nama_menu" required>
									</div>
									<div class="form-group">
								...
								<div class="modal-footer">
									...
									<button type="submit" class="btn btn-success"><i class="fas fa-sharp fa-solid fa-wine-glass fa-save"></i> Simpan</button>
								</div>
							</div>
						</form>
					</div>
