<div class="container">
    ...
    <div class="row my-2">
        ...
        <div class="col-lg-3">
            <div class="card shadow">
                <div class="card-body">
                    <h6><i class="text-success fas fa-fw fa-caret-up"></i> <i class="text-success fas fa-regular fa-money-bill"></i> <br>Omset</h6>
                    <?php
        ...
        <div class="col-lg-3">
            <div class="card shadow">
                <div class="card-body">
                    <h6><i class="text-danger fas fa-fw fa-caret-down"></i><i class="text-danger fas fa-regular fa-money-bill"></i> <br>Pengeluaran</h6>
                    <?php
